...
makeTree(conection, attributes, impurity function, a conditional to use in the where portion of a sql query, the original indentation of the tree (empty string), maximum error, minimum number of elements)



Get Accuracy of Tree:

verification(connection, table name, impurity calculation, (optional) reader structure)
...
For examples of these, refer to main.R
